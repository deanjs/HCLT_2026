...
**대응 RQ:** RQ3 관측 (지침 쪽). RQ2가 코드 쪽이면, 이건 지침 쪽 어텐션을 stepB 방법으로 본 것 — RQ3의 관측 입구(인과는 step4). stepB pool-500의 "지침 어텐션 평탄"이 **문장 통째** 기준이라, 그 안의 **핵심 지시어 토큰**('camelCase')을 실제로 보는지는 아직 모른다. 이걸 직접 잰다.
