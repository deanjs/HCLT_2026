...
- **선호 점수(간접).** 실제 생성으로 준수율이 오르는지(직관적 재확인)는 **생성 기반 개입**으로 보강 가능(후속).

**다음:** step 1(전 층 스윕 + Key/Value 분해 + v 코사인) → step 2(모델 다양성) → step 7(방법론).

*(그래프 원본: `docs/stepC/figs/`. 원자료: `results/stepC/` 60건.)*
